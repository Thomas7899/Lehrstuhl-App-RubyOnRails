...
%o`, message, error2, detail);
    ...
    function initChatbot() {
      ...
      const sendMessage = async (message) => {
        ...
        try {
          ...
          addMessage(`Entschuldigung, ein Fehler ist aufgetreten. (${error2.message})`, "assistant");
        } finally {
          toggleSendButton(false);
      ...
      if (typeof bootstrap !== "undefined") {
        ...
        dropdownButtons.forEach((button) => {
          try {
            ...
            console.error("Fehler bei Dropdown-Initialisierung:", error2);
          }
        });
      }
    }, 200);
  ...
  document.addEventListener("turbo:load", function() {
    function initStudentFilters() {
      ...
      searchInput.addEventListener("input", debounce2(applyFilters, 300));
